...
select * from employee where fname like 'p%e' ---name ends with e and starts with p

select * from employee where fname like '%j%' ---contains j
select * from employee where fname like '_a%' --name contais 2nd char a
select * from employee where fname like '[kp]%' --name starts with kp
select * from employee where fname not like '[kp]%' --name not start with kp